...
local Themes = {
	...
	Jester = {
		MainFrame = Color3.fromRGB(255,255,255),
		Minimise = Color3.fromRGB(25,255,0),
		MinimiseAccent = Color3.fromRGB(25,255,0),
		Maximise = Color3.fromRGB(255, 115, 115),
		MaximiseAccent = Color3.fromRGB(255, 115, 115),
		NavBar = Color3.fromRGB(230, 73, 178),
		NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(30,30,30),
		TitleBar = Color3.fromRGB(230, 73, 178),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		Overlay = Color3.fromRGB(230, 73, 178),
		Banner = Color3.fromRGB(255,255,255),
		BannerAccent = Color3.fromRGB(230, 73, 178),
		Content = Color3.fromRGB(230, 73, 178),
		Button = Color3.fromRGB(230, 73, 178),
		ButtonAccent = Color3.fromRGB(255,255,255),
		ChipSet = Color3.fromRGB(230, 73, 178),
		ChipSetAccent = Color3.fromRGB(255,255,255),
		DataTable = Color3.fromRGB(230, 73, 178),
		DataTableAccent = Color3.fromRGB(255,255,255),
		Slider = Color3.fromRGB(255,255,255),
		SliderAccent = Color3.fromRGB(230, 73, 178),
		Toggle = Color3.fromRGB(230, 73, 178),
		ToggleAccent = Color3.fromRGB(255,255,255),
		Dropdown = Color3.fromRGB(255,255,255),
		DropdownAccent = Color3.fromRGB(230, 73, 178),
		ColorPicker = Color3.fromRGB(255,255,255),
		ColorPickerAccent = Color3.fromRGB(230, 73, 178),
		TextField = Color3.fromRGB(175,175,175),
		TextFieldAccent = Color3.fromRGB(255,255,255),
	},
	Ben10 = {
